...
//     mBuffer: pddiPrimBuffer
//     SetBuffer = (buffer: pddiPrimBuffer) => this.mBuffer = buffer
//     SetVertices = (start: number, count: number, v: vec3) => {
//         const stream = this.mBuffer.Lock()
//         for (let a = 0; a < count; a++) {
//             stream.Coord(v[a][0], v[a][1], v[a][2])
//         }
//         this.mBuffer.Unlock(stream)
//         return true
//     }
// }
// export class tPrimGroupOptimised extends tPrimGroup {
...
//     // SetBuffer = () => { }
// }
// export class tPrimGroupSkinnedOptimised extends tPrimGroup {
//     constructor(i: number) { super() }
//     SetShader = (i: any) => { }
//     SetPrimType = (i: any) => { }
//     SetVertexFormat = (i: number) => { }
//     // SetBuffer = () => { }
// }
// export class pddiVertexComponentWidth { }
// export class pddiPrimBuffer { }
...
//     Lock = () => {
//         const basePtr = 0
//         const res: HRESULT = this.buffer.Lock(0, 0, basePtr, 0)
//         this.DDVERIFY(res)
//         const lockedVertex = true
//         const stream = this.GetPrimBufferStream()
//         stream.Lock()
//         stream.SetBasePtr(basePtr, this.vertexProgram, this.maxVertex, 0)
//         return stream
//     }
//     GetPrimBufferStream = () => { return }
//     SetBasePtr = () => { }
// }
// const nStaticPrimBufferStreams = 4
// const primBufferStreams = nArray(nStaticPrimBufferStreams, () => new d3dPrimBufferStream)
// export const GetPrimBufferStream = (): d3dPrimBufferStream | null => {
//     for (let i = 0; i < nStaticPrimBufferStreams; i++) {
...
//     return null
// }
// export class d3dVertexProgram { }
// export class d3dPrimBufferStream extends pddiPrimBufferStream {
//     locked = false
//     basePtr = null
//     nVertex = 0
//     maxVertex = 0
//     stride = 0
//     coord: pddiVector | null = null
//     normal: float = 0
...
//     }
// }
// // export namespace p3d {
// export class p3d {
//     // platform:    tPlatform
//     // context:     tContext
//     // inventory:   tInventory
//     // stack:       tMatrixStack
//     // loadManager: tLoadManager
//     // pddi:        pddiRenderContext
//     static device:      pddiDevice
//     // display:     pddiDisplay
// }
// export abstract class pddiDevice {
//     abstract NewTexture(_desc: pddiTextureDesc): pddiTexture
//     abstract NewPrimBuffer(desc: pddiPrimBufferDesc): pddiPrimBuffer
//     abstract NewShader(name: string, aux?: string): pddiShader
// }
// export class pddiTexture { }
// export class pddiTextureDesc { }

// export class pddiShader { }
