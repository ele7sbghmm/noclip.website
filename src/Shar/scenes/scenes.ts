...
import { FenceRenderer } from './fence_renderer.js'
...
const levels_: LevelPaths_[] = [
    ...
    { // l1
        index: 1,
        id: `l1`,
        default_render: [`i02`, `z1`],
        // global_sector_paths: [`L1_TERRA.p3d`, `l1_sr1p.p3d`],//, `missions/level01/jumps.p3d`],
        global_sector_paths: [`L2_TERRA.p3d`, `l1_sr1p.p3d`],//, `missions/level01/jumps.p3d`],
        sectors: [
...
export class Instance {
    ...
    renderFlow_instance: RenderFlow// = new RenderFlow
    ...
    // GetDSGFactory() { return this.GetRenderFlow().mpDSGFactory }
}
// const instances: (Instance | null)[] = [null, new Instance(1)]
class SceneDesc implements Viewer.SceneDesc {
    ...
    public async createScene(
        ...
        const level_instance = new Instance(1)
        ...
        const fences = level_instance!.GetRenderManager()!.pWorldRenderLayer().mLoadLists[0]!.mFenceElems
        return new FenceRenderer(gfxDevice, fences)
    }
}
