...
import { PgfRenderer } from './pgf/render.js'
...
export class Scene implements Viewer.SceneGfx {
    ...
    constructor(device: GfxDevice, pgf: Pgf) {
        ...
        this.model = new PgfRenderer(pgf, device, this.renderHelper.renderCache)
    }
    ...
    prepareToRender(device: GfxDevice, viewerInput: Viewer.ViewerRenderInput) {
        ...
        this.model.prepareToRender(this.renderHelper.renderInstManager)
