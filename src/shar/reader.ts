...
export class BufReader {
  ...
  public get_offs(): number { return this.offs; }
  public get_len(): number { return this.len; }
  public get_remaining(): number { return this.len - this.offs; }
  ...
  public le_f32(offset: number = 0, byteSize: number = 4, peek: boolean = false): f32 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
    const num: f32 = this.view.getFloat32(this.offs + offset, true);
    if (!peek)
      this.offs += byteSize;
    return num;
  }
  public le_u32(offset: number = 0, byteSize: number = 4, peek: boolean = false): u32 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public be_u32(offset: number = 0, byteSize: number = 4, peek: boolean = false): u32 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public le_i32(offset: number = 0, byteSize: number = 4, peek: boolean = false): i32 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public be_i32(offset: number = 0, byteSize: number = 4, peek: boolean = false): i32 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public le_u16(offset: number = 0, byteSize: number = 2, peek: boolean = false): u16 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public be_u16(offset: number = 0, byteSize: number = 2, peek: boolean = false): u16 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public le_i16(offset: number = 0, byteSize: number = 2, peek: boolean = false): i16 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public be_i16(offset: number = 0, byteSize: number = 2, peek: boolean = false): i16 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public u8(offset: number = 0, byteSize: number = 1, peek: boolean = false): u8 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
  ...
  public i8(offset: number = 0, byteSize: number = 1, peek: boolean = false): i8 {
    assert(this.len >= this.offs + offset + byteSize, `this.len=${offset} >= offset=${offset} + byteSize=${byteSize}`);
